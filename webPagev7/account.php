    ...
    <form class="loginForm" id="chngInfo" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <div class="frmGroup">
            ...
            <!-- <div class="itemContainers" >
                ...
                <input class="textBoxes" type="text" name="fFood" value="<?php echo htmlspecialchars($user['fFood']); ?>" required pattern="[A-Za-z ]+" oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '')"/>
            </div> -->
        </div>
...
<script>
    ...
    if(currentPath[0] === 'a' && currentPath[1] === 'c' && currentPath[2] === 'c' && currentPath[3] === 'o' && currentPath[4] === 'u' && currentPath[5] === 'n' && currentPath[6] === 't'){
        document.getElementById("nav4").style.background = "#FAD4DF"
