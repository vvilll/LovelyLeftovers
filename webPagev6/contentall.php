...
<script>
    ...
    if(currentPath[0] === 'c' && currentPath[1] === 'o' && currentPath[2] === 'n' && currentPath[3] === 't' && currentPath[4] === 'e' && currentPath[5] === 'n' && currentPath[6] === 't' && currentPath[7] === 'a' && currentPath[8] === 'l' && currentPath[9] === 'l'){
        document.getElementById("matchNav3").style.background = "#F8BBD0"
        document.getElementById("matchNavA3").style.color = "#C2185B"
    }
</script>
</html>