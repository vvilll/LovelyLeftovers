            ...
            <input type="hidden" name="refreshMatches" value="1">
                <div class="uCard" id="uCardL">
                    ...
                    <div class="cardAbout">
                        ...
                        <div>
                            <h3>Hobbies</h3>
                            <p><?php foreach($potentMatches[0]['relatedNodes'] as $related){echo $related['Label'] . "| ";}?></p>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <input type="hidden" name="refreshMatches" value="1">
                <div class="uCard" id="uCardM">
                    ...
                    <div class="cardAbout">
                        ...
                        <div>
                            <h3>Hobbies</h3>
                            <p><?php foreach($potentMatches[1]['relatedNodes'] as $related){echo $related['Label'] . "| ";}?></p>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <input type="hidden" name="refreshMatches" value="1">
                <div class="uCard" id="uCardR">
                    ...
                    <div class="cardAbout">
                        ...
                        <div>
                            <h3>Hobbies</h3>
                            <p><?php foreach($potentMatches[2]['relatedNodes'] as $related){echo $related['Label'] . "| ";}?></p>
                        </div>
                    </div>
                </div>
            </form>
