    ...
    <div class="body">
        ...
        <form class="bodyForm" method="post">
            ...
            <div>
                ...
                <input class="textBoxes" type="password" id="tIn2" name="password"><br>
            </div>
...
<script>
    ...
    if(currentPath[0] === 'i' && currentPath[1] === 'n' && currentPath[2] === 'd' && currentPath[3] === 'e' && currentPath[4] === 'x'){
        document.getElementById("nav1").style.background = "#FAD4DF"
